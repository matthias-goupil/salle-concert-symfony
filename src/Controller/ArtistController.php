...
class ArtistController extends AbstractController
{
    ...
    public function new(Request $request, ArtistRepository $artistRepository, FileUploader $fileUploader, MusicGroupRepository $musicGroupRepository): Response
    {
        $artist = new Artist();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $artist->setMusicGroup($musicGroupRepository->find($form->get('musicGroup')->getData()));
    ...
    public function edit(Request $request, Artist $artist, ArtistRepository $artistRepository, FileUploader $fileUploader, MusicGroupRepository $musicGroupRepository): Response
    {
        $form = $this->createForm(ArtistType::class, $artist, [
            "musicGroups" => $musicGroupRepository->findAll()
        ]);
